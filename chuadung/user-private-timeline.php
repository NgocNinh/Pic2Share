    ...
    <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu">
      <div data-scrollable>
        <div class="sidebar-block">
          <div class="profile">
            <img src="../images/avatar/110/<?php echo $row['avatar'];?>" alt="people" class="img-circle" />
      ...
      <div class="st-content">
        ...
        <div class="st-content-inner">
          <div class="cover overlay hover cover-image-full height-300">
            <img src="../images/cover/<?php echo $row['cover'];?>" alt="cover" />
            <div class="overlay overlay-full overlay-bg-black">
              
              <div class="v-top">                
                <button href="" class="btn btn-cover" onclick='showUploadform()'>
                  <i class="fa fa-pencil">
                    <div id='Uploadform' style="display:none;">
                      <form method="post" action="../user_manager/test/testupload.php" enctype="multipart/form-data">
                            ...
                            <form action='post.php' method='post'>
                              <div class="panel panel-default share clearfix-xs">
                                <div class="panel-heading panel-heading-gray title">
                                  Share your Picture and your Feeling...
                                </div>
                              
                                <div class="panel-body">
                                  <textarea name="describe" class="form-control share-text" rows="2" placeholder="Share your Picture and your Feeling..."></textarea>
                                </div>
                                <div class="panel-footer share-buttons">
                                  <i class="fa fa-photo"></i></br>
                                  <i class="fa icon-tag-fill-1"></i><input type='text' name='tag' /></br>                                  
                                  <i class="fa fa-video-camera"></i></br>
                                  <button id='post' type="submit" class="btn btn-primary btn-xs pull-right display-none" href="#">Post</button>
                                </div>
                              </div>
                            </form>
                          </div>
